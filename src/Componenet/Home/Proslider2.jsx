...
export default function Proslider2() {
  ...
  const getProducts = async () => {
    try {
      ...
      .filter((product) => product.category?.name === 'SUNGLASSES');
    ...
    <div className='container-fluid mt-5  justify-content-center align-items-center d-flex'>
      <div className='container row justify-content-center align-items-center d-flex'>
        ...
        <div className='col-2 justify-content-center align-items-center d-flex'>
            <Link to="/Sunglass" className='btn btn-dark px-5 py-2'>Shop All  </Link>
        </div>
      </div>
    </div>
      <Swiper
        ...
        {products.map((product) => (
          <SwiperSlide key={product.id} className="container slidermain" >
            ...
            >
              <div className="base-tile-header">
                <div className="badge-container">
                  <div className="daily-deals product-badge">
                    <span className="badge-title">New</span>
                  </div>
                </div>
              ...
              <div className="base-tile-price-rating" style={{ backgroundColor: '#fafafa' }}>
              ...
              <div className="base-tile-footer" style={{ backgroundColor: '#fafafa' }}>
                <div className="tile-color-swatch base-tile-color-swatch">
                  <div className="colors-container">
                    <button className="color-item-btn active-color normal-anchor-button" type="button" tabIndex="0">
                      <div className="active-border"></div>
                      <div className="color-item color-swatch-brown"></div>
                    </button>
                    <button className="color-item-btn normal-anchor-button" type="button" tabIndex="0">
