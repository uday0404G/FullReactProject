  ...
  return (
    <>
      ...
      <div className='ben'>
        <div className='ben-b '>
          <img
            src="https://static.zennioptical.com/marketing/plp/contacts24/240529_contacts_plp_banner_xl.png"
    ...
    marginLeft:" 17%" }}>
            <div className="text-wrapper">
              ...
              Brand-name contacts, wallet-happy prices: Save 20% on your first order plus free shipping!              </p>
            </div>
